...
hittable_list random_scene()
{
  ...
  auto ground_material = make_shared<lambertian>(make_shared<noise_texture>(4));
  ...
  auto material2 = make_shared<lambertian>(make_shared<marble_texture>(4));
  world.add(make_shared<sphere>(point3(4, 1, 0), 1, material2));

  auto material3 = make_shared<metal>(color(0.7, 0.6, 0.5), 0.0);
  world.add(make_shared<sphere>(point3(0, 1, 0), 1, material3));
